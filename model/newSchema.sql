...
CREATE TABLE Client (
  ...
  AvgTimeBetweenPickups INT NOT NULL CHECK (AvgTimeBetweenPickups >= 0),
  LocationNotes TEXT,
...
CREATE TABLE Receipt (
  ...
  PaymentMethod VARCHAR(20) NOT NULL, -- Set based on client payment method when created
  TotalVolume DECIMAL(10, 2) NOT NULL CHECK (TotalVolume >= 0),
...
CREATE TABLE Request (
  ...
  NumFullBarrels INT NOT NULL CHECK (NumFullBarrels >= 0),
  LargeObjects TEXT,
  Notes TEXT,
  FOREIGN KEY (ClientID) REFERENCES Client(ClientID)
);
...
CREATE TABLE AutoClientTotals (
  ClientID VARCHAR(20) PRIMARY KEY, 
  TotalDrumsRotors DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalShortIron DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalShredSteel DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalAluminumBreakage DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalDirtyAluminumRadiators DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalWiringHarness DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalACCompressor DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalAlternatorStarter DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalAluminumRims DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalChromeRims DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalBrassCopperRadiator DECIMAL(15, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE AutoReceiptMetals (
  ...
  DrumsRotorsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DrumsRotorsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ShortIronWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ShortIronPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ShredSteelWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ShredSteelPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  AluminumBreakageWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  AluminumBreakagePrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DirtyAluminumRadiatorsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DirtyAluminumRadiatorsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  WiringHarnessWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  WiringHarnessPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ACCompressorWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ACCompressorPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  AlternatorStarterWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  AlternatorStarterPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  AluminumRimsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  AluminumRimsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ChromeRimsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ChromeRimsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  BrassCopperRadiatorWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE CatalyticConverter (
  ...
  Price DECIMAL(10, 2) NOT NULL CHECK (Price >= 0),
  PercentFull DECIMAL(5, 2) NOT NULL CHECK (PercentFull >= 0 AND PercentFull <= 100),
  FOREIGN KEY (ReceiptID) REFERENCES Receipt(ReceiptID)
);
...
CREATE TABLE HVACClientTotals (
  ClientID VARCHAR(20) PRIMARY KEY, 
  TotalShredSteel DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalDirtyAlumCopperRadiators DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalCleanAluminumRadiators DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalCopperTwo DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalCompressors DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalDirtyBrass DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalElectricMotors DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalAluminumBreakage DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalPayout DECIMAL(15, 2) NOT NULL DEFAULT 0,
  FOREIGN KEY (ClientID) REFERENCES Client(ClientID)
);
...
CREATE TABLE HVACReceiptMetals (
  ...
  ShredSteelWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ShredSteelPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DirtyAlumCopperRadiatorsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DirtyAlumCopperRadiatorsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  CleanAluminumRadiatorsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  CleanAluminumRadiatorsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  CopperTwoWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  CopperTwoPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  CompressorsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  CompressorsPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DirtyBrassWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
  DirtyBrassPrice DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ElectricMotorsWeight DECIMAL(10, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE InsulationClientTotals (
  ClientID VARCHAR(20) PRIMARY KEY, 
  TotalDumpFees DECIMAL(15, 2) NOT NULL DEFAULT 0,
  TotalHaulFees DECIMAL(15, 2) NOT NULL DEFAULT 0,
  FOREIGN KEY (ClientID) REFERENCES Client(ClientID)
);
...
CREATE TABLE InsulationReceiptMetals (
  ReceiptID INT PRIMARY KEY,
  DumpFee DECIMAL(10, 2) NOT NULL DEFAULT 0,
  HaulFee DECIMAL(10, 2) NOT NULL DEFAULT 0,
  FOREIGN KEY (ReceiptID) REFERENCES Receipt(ReceiptID)
);
